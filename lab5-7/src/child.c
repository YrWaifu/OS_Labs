...
int main(int argc, char const *argv[]) {
    ...
    void *responder = createZmqSocket(context, ZMQ_REP);  // прием запросов и отправка ответов
    void *requester = createZmqSocket(context, ZMQ_REQ);  // отправка запросов и прием ответов
